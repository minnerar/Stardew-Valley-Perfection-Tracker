...
//    }
    ...
    public boolean equals(Object o) {
        ...
        return id == item.id && classification == item.classification && completed == item.completed &&
                ...
                Objects.equals(description, item.description) && Objects.equals(imageURL, item.imageURL);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, classification, name, completed, season, time, weather, location, description, imageURL);
    }
